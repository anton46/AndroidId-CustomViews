...
public class PieChart extends ViewGroup {
     ...
     *                {@link com.anton.sample.R.styleable.PieChart} as well as attributes inherited
     *                from {@link View}.
     */
    public PieChart(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mShowText = a.getBoolean(R.styleable.PieChart_pc_showText, false);
            mTextY = a.getDimension(R.styleable.PieChart_pc_labelY, 0.0f);
            mTextWidth = a.getDimension(R.styleable.PieChart_pc_labelWidth, 0.0f);
            mTextHeight = a.getDimension(R.styleable.PieChart_pc_labelHeight, 0.0f);
            mTextPos = a.getInteger(R.styleable.PieChart_pc_labelPosition, 0);
            mTextColor = a.getColor(R.styleable.PieChart_pc_labelColor, 0xff000000);
            mHighlightStrength = a.getFloat(R.styleable.PieChart_pc_highlightStrength, 1.0f);
            mPieRotation = a.getInt(R.styleable.PieChart_pc_pieRotation, 0);
            mPointerRadius = a.getDimension(R.styleable.PieChart_pc_pointerRadius, 2.0f);
            mAutoCenterInSlice = a.getBoolean(R.styleable.PieChart_pc_autoCenterPointerInSlice, false);
        } finally {
